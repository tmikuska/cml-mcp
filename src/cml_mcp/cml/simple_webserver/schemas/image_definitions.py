...
class ImageDefinition(BaseModel, extra="forbid"):
    ...
    disk_image: FilePath | None = Field(
        default=None, description="A source image for the image definition."
    )
    efi_boot: bool = Field(
        default=False,
    ...
    disk_image_2: FilePath | None = Field(
        default=None, description="A second source image for the image definition."
    )
    disk_image_3: FilePath | None = Field(
        default=None, description="A third source image for the image definition."
    )
    disk_image_4: FilePath | None = Field(
        default=None, description="A fourth source image for the image definition."
    )
    ...
    data_volume: int | None = Field(
        default=None, ge=0, le=4096, description="Data Disk Size (GiB)."
    )
    boot_disk_size: int | None = Field(
        default=None, ge=0, le=4096, description="Boot Disk Size (GiB)."
    )
