...
_INVALID_WIRE = ["invalid"]


@pytest.mark.parametrize(("wire", "expected"), _CANONICAL_WIRE + _LEGACY_WIRE)
...
@pytest.mark.parametrize("wire", _INVALID_WIRE)
...
def test_wire_topology_border_styles_migrates_legacy():
    payload = {
